...
#   twentytwentyfour
#
# # Delete default post after installation:
# wp post delete $(wp post list --post_type='post' --format=ids) --force
#
# # Delete default pages after installation:
...
# wp rewrite structure '/%category%/%postname%/'  && wp rewrite flush --hard
#
